...
# OpenSSL is used by Mbed TLS test 8103 and enabled via CFG_TA_MBEDTLS=y but it
# CAN'T be supported here since:
# 1.
# LOCAL_SHARED_LIBRARIES += libcrypto
# will link xtest to
# out/target/product/hikey/obj/SHARED_LIBRARIES/libcrypto.vendor_intermediates/libcrypto.vendor.so
# but it's built out of external/boringssl and doesn't have symbols like OPENSSL_init
# 2.
# ifeq ($(TARGET_ARCH),arm64)
# LOCAL_LDFLAGS += $(LOCAL_PATH)/host/openssl/lib/aarch64/libcrypto.a -ldl
# else
# LOCAL_LDFLAGS += $(LOCAL_PATH)/host/openssl/lib/arm/libcrypto.a -ldl
# endif
# will NOT work either since libcrypto.a was linked against glibc and contains
# symbols not available in bionic like __ctype_b_loc
